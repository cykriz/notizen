...
export async function readCachedTodos(page: Page): Promise<Record<string, unknown>[]> {
  return readKey<Record<string, unknown>>(page, TODOS_KEY);
}
