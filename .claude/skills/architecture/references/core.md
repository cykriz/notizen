...
- `lib/tagConstants.ts` — German strings for the sidebar tag navigation and the palette's tag mode (same reason); most are the accessible names the e2e tests locate by, exceptions are marked
